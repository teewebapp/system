...
$baseUrlRelative = '/system/userfiles/';

$baseUrl = $baseUrlRelative;

$requestUri = $_SERVER['REQUEST_URI'];
$requestUriAux = explode('/', trim($requestUri, '/'));

if(in_array('public', $requestUriAux)) {
	$aux = array_slice($requestUriAux, 0, array_search('public', $requestUriAux)+1);
	$baseUrl = '/'.implode('/', $aux).$baseUrl;
}
...
while(basename($dir) != 'public') {
	$dir = dirname($dir);
}

$baseDir = $dir.$baseUrlRelative;
